...
Non-first-class side projects. Pet projects, experiments, exploration outside main research/work.
Do not place Lattice, ArgOS, or WorkBrain here.
...
See `workspace/side-projects/KNOWLEDGE.md` for the domain knowledge index.
